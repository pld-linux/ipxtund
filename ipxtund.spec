...
ipxtund łączy sieci bazujące na IPX poprzez TCP/IP. Narzędzie to
pozwala na np. granie w gry bazujące na IPX graczom w różnych sieciach
o ile tylko sieci te są połączone do sieci WAN TCP/IP takiej jak
Internet.
